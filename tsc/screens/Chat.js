...
import { View, Text, TextInput, FlatList, KeyboardAvoidingView, Image, ActivityIndicator } from 'react-native';
...
class Chat extends React.Component {
  ...
  render() {
    ...
    if (!this.props.messages) return <ActivityIndicator style={styles.container2}/>
    return (
